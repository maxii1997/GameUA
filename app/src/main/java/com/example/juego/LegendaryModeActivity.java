...
public class LegendaryModeActivity extends AppCompatActivity implements SensorEventListener, GestureDetector.OnGestureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_legendary_mode);
        ...
        musicFondo = MediaPlayer.create(this, R.raw.fondoo);
        ...
        gestos = new GestureDetector(this, new LegendaryModeActivity.ListenerGestos());
    ...
    private void handleInstructionTimeLimit() {
        ...
        lives--;
        updateLives();
        Toast.makeText(this, "Se ha agotado el tiempo límite.", Toast.LENGTH_SHORT).show();
    ...
    private int getInstructionTimeLimit() {
        switch (currentLevel) {
            case 1:
                return 3000; // 3 segundos para el nivel 1
            default:
                return 3000; // 3 segundos para los demás niveles
        }
    }
    ...
    private void checkGesture(String Gesture) {
        ...
        if (Gesture.equals(expectedGesture)) {
            ...
            if (lives > 0) {
                lives--;
                updateLives();
                Toast.makeText(this, "Acción equivocada.", Toast.LENGTH_SHORT).show();
                // Reproducir el sonido de derrota
                musicLoss.start();
                if (lives == 0) {
                    gameOver();
    ...
    private void showRestartDialog() {
        ...
        builder.setTitle("Game Over")
                .setMessage("Has perdido. Puntaje obtenido: " + score + "\n¿Deseas reiniciar el juego?")
                ...
                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(LegendaryModeActivity.this, MenuActivity.class);
